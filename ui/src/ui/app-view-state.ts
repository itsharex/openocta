...
export type AppViewState = {
  ...
  modelLibraryCategory: "__all__" | "plaza" | "public" | "local";
  modelLibrarySelectedProvider: string | null;
  embeddedModelsLoading: boolean;
  embeddedModelsError: string | null;
  embeddedModels: import("./controllers/embedded-models.ts").EmbeddedModelEntry[];
  embeddedModelsBusyId: string | null;
  embeddedDownloadStatus: import("./controllers/embedded-models.ts").EmbeddedDownloadStatus | null;
  embeddedPlazaDetailModel: import("./controllers/embedded-models.ts").EmbeddedModelEntry | null;
  ...
  appUpdateCheckLoading: boolean;
  appUpdateInstalling: boolean;
  appUpdateInfo: import("./controllers/app-update.ts").AppUpdateCheckResult | null;
  appUpdateInstallProgress: import("./controllers/app-update.ts").AppUpdateProgress | null;
  appUpdateError: string | null;
  appUpdateManualHint: string | null;
  handleAppUpdateCheckClick: () => void;
  handleAppUpdateModalClose: () => void;
  handleAppUpdateSkipClick: () => void | Promise<void>;
  handleAppUpdateInstallClick: () => void | Promise<void>;
  handleAppUpdateCopyManualHintClick: () => void | Promise<void>;
  handleAppUpdateOpenDownloadClick: () => void;
